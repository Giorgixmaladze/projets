...
const LocationMain = () =>{
    return(
        <div className="min-[375px]:w-11/12 min-[375px]:pt-10 min-[375px]:flex min-[375px]:flex-col min-[375px]:gap-8">
                <iframe
                    title="Location map"
                ...
                ></iframe>
                <div className="min-[375px]:flex min-[375px]:flex-col min-[375px]:gap-2">
