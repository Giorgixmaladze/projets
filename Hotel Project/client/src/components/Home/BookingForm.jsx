const BookingForm = () => {
    return (
        <div className="bg-gray-100 w-11/12 min-[375px]:flex min-[375px]:justify-center min-[375px]:h-[70vh] min-[375px]:items-center min-md:h-[50vh]">
            <form action="" className="min-[375px]:flex min-[375px]:flex-col min-[375px]:gap-[15px] min-[375px]:w-11/12">
                ...
                <div className="min-[375px]:w-full min-[375px]:flex min-[375px]:flex-col min-[375px]:gap-5 min-md:flex-row min-md:justify-center">
                    <div className=" min-[375px]:flex min-[375px]:flex-col min-[375px]:gap-5 min-md:w-6/12">
                        <input
                            type="text"
                            name="arrivalDate"
